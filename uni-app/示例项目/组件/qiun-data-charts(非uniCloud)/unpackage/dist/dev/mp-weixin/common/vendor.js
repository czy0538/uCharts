...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"qiun-charts","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 44:
/*!****************************************************************************************************************************************************!*\
  !*** D:/Personal/UserData/My Documents/HBuilderProjects/uCharts/uni-app/示例项目/组件/qiun-data-charts(非uniCloud)/components/u-charts/config-ucharts.js ***!
  \****************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 5:
/*!*************************************************************************************************************************!*\
  !*** D:/Personal/UserData/My Documents/HBuilderProjects/uCharts/uni-app/示例项目/组件/qiun-data-charts(非uniCloud)/pages.json ***!
  \*************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 85:
/*!**********************************************************************************************************************************************!*\
  !*** D:/Personal/UserData/My Documents/HBuilderProjects/uCharts/uni-app/示例项目/组件/qiun-data-charts(非uniCloud)/components/u-charts/u-charts.js ***!
  \**********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function calYAxisData(series, opts, config, context) {
  ...
  if (YLength > 0) {
    ...
    _i14) {
      ...
      rangesFormatArr[_i14] = rangesArr[_i14].map(function (items) {
...
function drawMarkLine(opts, config, context) {
  ...
  for (var i = 0; i < points.length; i++) {
    ...
    context.setLineDash([]);
    if (item.showLabel) {
      var labelText = item.labelText ? item.labelText : opts.yAxis.formatter ? opts.yAxis.formatter(item.value) : item.value;
      context.setFontSize(config.fontSize);
      var textWidth = measureText(labelText, config.fontSize, context);
  ...
  switch (mountOption.type) {
      ...
      for (var i = 0; i < points.length; i++) {
        ...
        if (item !== null && i > leftNum && i < rightNum) {
          ...
          if (mountOption.barBorderRadius && mountOption.barBorderRadius.length === 4 || mountOption.barBorderCircle === true) {
            ...
            var top = item.y;
            var width = item.width;
            var _height2 = opts.height - opts.area[2] - item.y - mountOption.borderWidth * opts.pix / 2;
    ...
    case 'triangle':
      for (var _i19 = 0; _i19 < points.length; _i19++) {
        ...
        if (_item10 !== null && _i19 > leftNum && _i19 < rightNum) {
          ...
          context.lineTo(startX + _item10.width, opts.height - opts.area[2]);
          context.setStrokeStyle(strokeColor);
          context.setFillStyle(fillColor);
          if (mountOption.borderWidth > 0) {
            context.setLineWidth(mountOption.borderWidth * opts.pix);
    ...
    case 'mount':
      for (var _i20 = 0; _i20 < points.length; _i20++) {
        ...
        if (_item11 !== null && _i20 > leftNum && _i20 < rightNum) {
          ...
          context.moveTo(startX, opts.height - opts.area[2]);
          context.bezierCurveTo(_item11.x - _item11.width / 4, opts.height - opts.area[2], _item11.x - _item11.width / 4, _item11.y, _item11.x, _item11.y);
          context.bezierCurveTo(_item11.x + _item11.width / 4, _item11.y, _item11.x + _item11.width / 4, opts.height - opts.area[2], startX + _item11.width, opts.height - opts.area[2]);
          context.setStrokeStyle(strokeColor);
          context.setFillStyle(fillColor);
          if (mountOption.borderWidth > 0) {
            context.setLineWidth(mountOption.borderWidth * opts.pix);
    ...
    case 'sharp':
      for (var _i21 = 0; _i21 < points.length; _i21++) {
        var _item12 = points[_i21];
        if (_item12 !== null && _i21 > leftNum && _i21 < rightNum) {
          var startX = _item12.x - eachSpacing * mountOption.widthRatio / 2;
          var height = opts.height - _item12.y - opts.area[2];
          context.beginPath();
          var fillColor = _item12.color || series[_i21].color;
          var strokeColor = _item12.color || series[_i21].color;
          if (mountOption.linearType !== 'none') {
            var grd = context.createLinearGradient(startX, _item12.y, startX, opts.height - opts.area[2]);
            //透明渐变
            if (mountOption.linearType == 'opacity') {
              grd.addColorStop(0, hexToRgb(fillColor, mountOption.linearOpacity));
              grd.addColorStop(1, hexToRgb(fillColor, 1));
            } else {
              grd.addColorStop(0, hexToRgb(mountOption.customColor[series[_i21].linearIndex], mountOption.linearOpacity));
              grd.addColorStop(mountOption.colorStop, hexToRgb(mountOption.customColor[series[_i21].linearIndex], mountOption.linearOpacity));
              grd.addColorStop(1, hexToRgb(fillColor, 1));
            }
            fillColor = grd;
          }
          context.moveTo(startX, opts.height - opts.area[2]);
          context.quadraticCurveTo(_item12.x - 0, opts.height - opts.area[2] - height / 4, _item12.x, _item12.y);
          context.quadraticCurveTo(_item12.x + 0, opts.height - opts.area[2] - height / 4, startX + _item12.width, opts.height - opts.area[2]);
          context.setStrokeStyle(strokeColor);
          context.setFillStyle(fillColor);
          if (mountOption.borderWidth > 0) {
            context.setLineWidth(mountOption.borderWidth * opts.pix);
    ...
    switch (columnOption.type) {
      case 'group':
        ...
        for (var _i22 = 0; _i22 < points.length; _i22++) {
          var item = points[_i22];
          //fix issues/I27B1N yyoinge & Joeshu
          if (item !== null && _i22 > leftNum && _i22 < rightNum) {
            //var startX = item.x - item.width / 2;
            var startX = opts.area[3];
      ...
      case 'stack':
        ...
        for (var _i23 = 0; _i23 < points.length; _i23++) {
          var _item13 = points[_i23];
          if (_item13 !== null && _i23 > leftNum && _i23 < rightNum) {
            context.beginPath();
            var fillColor = _item13.color || eachSeries.color;
            var startX = _item13.x0;
            context.setFillStyle(fillColor);
            context.moveTo(startX, _item13.y - _item13.width / 2);
            context.fillRect(startX, _item13.y - _item13.width / 2, _item13.height, _item13.width);
            context.closePath();
            context.fill();
          }
        };
      ...
      if (_points2.length > 1) {
        ...
        if (areaOption.type === 'straight') {
          for (var _j = 0; _j < _points2.length; _j++) {
            var _item14 = _points2[_j];
            if (startPoint == 0 && _item14.x > leftSpace) {
              context.moveTo(_item14.x, _item14.y);
              startPoint = 1;
            }
            if (_j > 0 && _item14.x > leftSpace && _item14.x < rightSpace) {
        ...
        if (areaOption.type === 'step') {
          for (var _j2 = 0; _j2 < _points2.length; _j2++) {
            var _item15 = _points2[_j2];
            if (startPoint == 0 && _item15.x > leftSpace) {
              context.moveTo(_item15.x, _item15.y);
              startPoint = 1;
            }
            if (_j2 > 0 && _item15.x > leftSpace && _item15.x < rightSpace) {
              context.lineTo(_item15.x, _points2[_j2 - 1].y);
        ...
        var _item16 = _points2[0];
        context.moveTo(_item16.x - eachSpacing / 2, _item16.y);
        context.lineTo(_item16.x + eachSpacing / 2, _item16.y);
        context.lineTo(_item16.x + eachSpacing / 2, endY);
        context.lineTo(_item16.x - eachSpacing / 2, endY);
        context.moveTo(_item16.x - eachSpacing / 2, _item16.y);
      }
      context.closePath();
        ...
        if (_points2.length === 1) {
          ...
          if (areaOption.type === 'curve') {
            for (var _j3 = 0; _j3 < _points2.length; _j3++) {
              var _item17 = _points2[_j3];
              if (_startPoint == 0 && _item17.x > leftSpace) {
                context.moveTo(_item17.x, _item17.y);
                _startPoint = 1;
              }
              if (_j3 > 0 && _item17.x > leftSpace && _item17.x < rightSpace) {
                var _ctrlPoint = createCurveControlPoints(_points2, _j3 - 1);
                context.bezierCurveTo(_ctrlPoint.ctrA.x, _ctrlPoint.ctrA.y, _ctrlPoint.ctrB.x, _ctrlPoint.ctrB.y, _item17.x, _item17.y);
              }
            };
          }
          if (areaOption.type === 'straight') {
            for (var _j4 = 0; _j4 < _points2.length; _j4++) {
              var _item18 = _points2[_j4];
              if (_startPoint == 0 && _item18.x > leftSpace) {
                context.moveTo(_item18.x, _item18.y);
                _startPoint = 1;
              }
              if (_j4 > 0 && _item18.x > leftSpace && _item18.x < rightSpace) {
          ...
          if (areaOption.type === 'step') {
            for (var _j5 = 0; _j5 < _points2.length; _j5++) {
              var _item19 = _points2[_j5];
              if (_startPoint == 0 && _item19.x > leftSpace) {
                context.moveTo(_item19.x, _item19.y);
                _startPoint = 1;
              }
              if (_j5 > 0 && _item19.x > leftSpace && _item19.x < rightSpace) {
                context.lineTo(_item19.x, _points2[_j5 - 1].y);
      ...
      if (points.length === 1) {
        ...
        if (lineOption.type === 'straight') {
          for (var _j6 = 0; _j6 < points.length; _j6++) {
            var _item20 = points[_j6];
            if (startPoint == 0 && _item20.x > leftSpace) {
              context.moveTo(_item20.x, _item20.y);
              startPoint = 1;
            }
            if (_j6 > 0 && _item20.x > leftSpace && _item20.x < rightSpace) {
        ...
        if (lineOption.type === 'step') {
          for (var _j7 = 0; _j7 < points.length; _j7++) {
            var _item21 = points[_j7];
            if (startPoint == 0 && _item21.x > leftSpace) {
              context.moveTo(_item21.x, _item21.y);
              startPoint = 1;
            }
            if (_j7 > 0 && _item21.x > leftSpace && _item21.x < rightSpace) {
              context.lineTo(_item21.x, points[_j7 - 1].y);
              context.lineTo(_item21.x, _item21.y);
            }
          };
        }
        context.moveTo(points[0].x, points[0].y);
...
function drawMixDataPoints(series, opts, config, context) {
  ...
  series.forEach(function (eachSeries, seriesIndex) {
      ...
      for (var i = 0; i < points.length; i++) {
        ...
        if (item !== null && i > leftNum && i < rightNum) {
          ...
          if (columnOption.barBorderRadius && columnOption.barBorderRadius.length === 4 || columnOption.barBorderCircle) {
            ...
            var top = item.y;
            var width = item.width;
            var _height4 = opts.height - opts.area[2] - item.y;
            if (columnOption.barBorderCircle) {
              columnOption.barBorderRadius = [width / 2, width / 2, 0, 0];
            ...
            context.arc(left + r0, top + r0, r0, -Math.PI, -Math.PI / 2);
            context.arc(left + width - r1, top + r1, r1, -Math.PI / 2, 0);
            context.arc(left + width - r2, top + _height4 - r2, r2, 0, Math.PI / 2);
            context.arc(left + r3, top + _height4 - r3, r3, Math.PI / 2, Math.PI);
          } else {
            context.moveTo(startX, item.y);
            context.lineTo(startX + item.width, item.y);
            context.lineTo(startX + item.width, opts.height - opts.area[2]);
    ...
    if (eachSeries.type == 'area') {
      ...
      for (var _i24 = 0; _i24 < _splitPointList.length; _i24++) {
        var _points3 = _splitPointList[_i24];
        // 绘制区域数据
        context.beginPath();
        context.setStrokeStyle(eachSeries.color);
        ...
        if (_points3.length > 1) {
          ...
          if (eachSeries.style === 'curve') {
            for (var j = 0; j < _points3.length; j++) {
              var _item22 = _points3[j];
              if (startPoint == 0 && _item22.x > leftSpace) {
                context.moveTo(_item22.x, _item22.y);
                startPoint = 1;
              }
              if (j > 0 && _item22.x > leftSpace && _item22.x < rightSpace) {
            ...
            for (var _j8 = 0; _j8 < _points3.length; _j8++) {
              var _item23 = _points3[_j8];
              if (startPoint == 0 && _item23.x > leftSpace) {
                context.moveTo(_item23.x, _item23.y);
                startPoint = 1;
              }
              if (_j8 > 0 && _item23.x > leftSpace && _item23.x < rightSpace) {
          ...
          var _item24 = _points3[0];
          context.moveTo(_item24.x - eachSpacing / 2, _item24.y);
          context.lineTo(_item24.x + eachSpacing / 2, _item24.y);
          context.lineTo(_item24.x + eachSpacing / 2, endY);
          context.lineTo(_item24.x - eachSpacing / 2, endY);
          context.moveTo(_item24.x - eachSpacing / 2, _item24.y);
        }
        context.closePath();
        ...
        if (points.length === 1) {
          ...
          if (eachSeries.style == 'curve') {
            for (var _j9 = 0; _j9 < points.length; _j9++) {
              var _item25 = points[_j9];
              if (_startPoint2 == 0 && _item25.x > leftSpace) {
                context.moveTo(_item25.x, _item25.y);
                _startPoint2 = 1;
              }
              if (_j9 > 0 && _item25.x > leftSpace && _item25.x < rightSpace) {
            ...
            for (var _j10 = 0; _j10 < points.length; _j10++) {
              var _item26 = points[_j10];
              if (_startPoint2 == 0 && _item26.x > leftSpace) {
                context.moveTo(_item26.x, _item26.y);
                _startPoint2 = 1;
              }
              if (_j10 > 0 && _item26.x > leftSpace && _item26.x < rightSpace) {
                context.lineTo(_item26.x, _item26.y);
              }
            }
          }
          context.moveTo(points[0].x, points[0].y);
...
function drawYAxis(series, opts, config, context) {
  ...
  if (opts.yAxis.data) {var _loop4 = function _loop4(
    i) {
      ...
      points = [];
      if (yData.type === 'categories') {
        for (var _i25 = 0; _i25 <= yData.categories.length; _i25++) {
          points.push(opts.area[0] + spacingValid / yData.categories.length / 2 + spacingValid / yData.categories.length * _i25);
        }
      } else {
        for (var _i26 = 0; _i26 <= opts.yAxis.splitNumber; _i26++) {
          points.push(opts.area[0] + eachSpacing * _i26);
        }
      }
      if (yData.disabled !== true) {
...
function drawGaugeDataPoints(categories, series, opts, config, context) {
  ...
  if (gaugeOption.type == 'progress') {
    ...
    context.setLineWidth(gaugeOption.width);
    context.setLineCap('butt');
    for (var _i27 = 0; _i27 < categories.length; _i27++) {
      var eachCategories = categories[_i27];
      context.beginPath();
    ...
    context.translate(centerPosition.x, centerPosition.y);
    context.rotate((gaugeOption.startAngle - 1) * Math.PI);
    for (var _i28 = 0; _i28 < gaugeOption.splitLine.splitNumber + 1; _i28++) {
      context.beginPath();
    ...
    context.translate(centerPosition.x, centerPosition.y);
    context.rotate((gaugeOption.startAngle - 1) * Math.PI);
    for (var _i29 = 0; _i29 < gaugeOption.splitLine.splitNumber * gaugeOption.splitLine.childNumber + 1; _i29++) {
      context.beginPath();
      context.setStrokeStyle(gaugeOption.splitLine.color);
      context.setLineWidth(1 * opts.pix);
      context.moveTo(_startX2, 0);
    ...
    for (var _i30 = 0; _i30 < series.length; _i30++) {
      var eachSeries = series[_i30];
      context.save();
      context.translate(centerPosition.x, centerPosition.y);
...
function getWordCloudPoint(opts, type, context) {
  ...
  switch (type) {
    ...
    case 'vertical':var
      ...
      for (var _i31 = 0; _i31 < points.length; _i31++) {
        var _text = points[_i31].name;
        var _tHeight = points[_i31].textSize * opts.pix;
        ...
        if (isSpin) {
          points[_i31].area = areav;
          points[_i31].areav = _area;
        } else {
          points[_i31].area = _area;
        }
        points[_i31].rotate = isSpin;
      };
      break;}
...
function drawFunnelDataPoints(series, opts, config, context) {
  ...
  if (funnelOption.type == 'pyramid') {
    ...
    for (var _i32 = 0; _i32 < series.length; _i32++) {
      if (_i32 == 0) {
        if (opts.tooltip) {
          if (opts.tooltip.index == _i32) {
            context.beginPath();
            context.setFillStyle(hexToRgb(series[_i32].color, funnelOption.activeOpacity));
            context.moveTo(-activeWidth, 0);
            context.lineTo(-series[_i32].radius - activeWidth, -eachSpacing);
            context.lineTo(series[_i32].radius + activeWidth, -eachSpacing);
        ...
        series[_i32].funnelArea = [centerPosition.x - series[_i32].radius, centerPosition.y - eachSpacing, centerPosition.x + series[_i32].radius, centerPosition.y];
        context.beginPath();
        context.setLineWidth(funnelOption.borderWidth * opts.pix);
        context.setStrokeStyle(funnelOption.borderColor);
        var fillColor = hexToRgb(series[_i32].color, funnelOption.fillOpacity);
        if (funnelOption.linearType == 'custom') {
          var grd = context.createLinearGradient(series[_i32].radius, -eachSpacing, -series[_i32].radius, -eachSpacing);
          grd.addColorStop(0, hexToRgb(series[_i32].color, funnelOption.fillOpacity));
          grd.addColorStop(0.5, hexToRgb(funnelOption.customColor[series[_i32].linearIndex], funnelOption.fillOpacity));
          grd.addColorStop(1, hexToRgb(series[_i32].color, funnelOption.fillOpacity));
          fillColor = grd;
        }
        context.setFillStyle(fillColor);
        context.moveTo(0, 0);
        context.lineTo(-series[_i32].radius, -eachSpacing);
        context.lineTo(series[_i32].radius, -eachSpacing);
        context.lineTo(0, 0);
        context.closePath();
        context.fill();
        ...
        if (opts.tooltip) {
          if (opts.tooltip.index == _i32) {
            ...
            context.setFillStyle(hexToRgb(series[_i32].color, funnelOption.activeOpacity));
            context.moveTo(0, 0);
            context.lineTo(-series[_i32 - 1].radius - activeWidth, 0);
            context.lineTo(-series[_i32].radius - activeWidth, -eachSpacing);
            context.lineTo(series[_i32].radius + activeWidth, -eachSpacing);
            context.lineTo(series[_i32 - 1].radius + activeWidth, 0);
            context.lineTo(0, 0);
        ...
        series[_i32].funnelArea = [centerPosition.x - series[_i32].radius, centerPosition.y - eachSpacing * (_i32 + 1), centerPosition.x + series[_i32].radius, centerPosition.y - eachSpacing * _i32];
        context.beginPath();
        context.setLineWidth(funnelOption.borderWidth * opts.pix);
        context.setStrokeStyle(funnelOption.borderColor);
        var fillColor = hexToRgb(series[_i32].color, funnelOption.fillOpacity);
        ...
        context.setFillStyle(fillColor);
        context.moveTo(0, 0);
        context.lineTo(-series[_i32 - 1].radius, 0);
        context.lineTo(-series[_i32].radius, -eachSpacing);
        context.lineTo(series[_i32].radius, -eachSpacing);
        context.lineTo(series[_i32 - 1].radius, 0);
        context.lineTo(0, 0);
...
function drawCharts(type, opts, config, context) {
  ...
  if (opts.type === 'line' || opts.type === 'column' || opts.type === 'mount' || opts.type === 'area' || opts.type === 'mix' || opts.type === 'candle' || opts.type === 'scatter' || opts.type === 'bubble' || opts.type === 'bar') {
    ...
    leftIndex = 0;
    //计算主绘图区域左右位置
    for (var _i33 = 0; _i33 < yAxisWidth.length; _i33++) {
      if (yAxisWidth[_i33].position == 'left') {
        if (leftIndex > 0) {
          opts.area[3] += yAxisWidth[_i33].width + opts.yAxis.padding * opts.pix;
        } else {
          opts.area[3] += yAxisWidth[_i33].width;
        }
        leftIndex += 1;
      } else if (yAxisWidth[_i33].position == 'right') {
        if (rightIndex > 0) {
          opts.area[1] += yAxisWidth[_i33].width + opts.yAxis.padding * opts.pix;
        } else {
          opts.area[1] += yAxisWidth[_i33].width;
        }
        rightIndex += 1;
      }
    }
...
uCharts.prototype.dobuleZoom = function (e) {
  ...
  var centerX = Math.min(tcs[0].x, tcs[1].x) + Math.abs(tcs[0].x - tcs[1].x) / 2;
  // 中间点的索引值
  ...
  var len = _sacle(tcs[0].x, tcs[0].y, tcs[1].x, tcs[1].y);
  if (!this.scrollOption.moveLength) {
    this.scrollOption.moveLength = len;
    return;
  }
  // 根据移动距离改变itemCount
  var gap = this.scrollOption.moveLength > len ? 1 : -1;
  var itemCount = this.opts.xAxis.itemCount || 4;
  ...
  endX = _getXAxisPoints0.endX,
  eachSpacing = _getXAxisPoints0.eachSpacing;
  var currentLeft = eachSpacing * this.scrollOption.moveCurrent;
  var screenWidth = endX - startX;
  var MaxLeft = screenWidth - eachSpacing * (xAxisPoints.length - 1);
