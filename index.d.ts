interface UchartsSetOption {
  ...
  type: 'pie' | 'line' | 'column' | 'area' | 'ring' | 'radar' | 'arcbar' | 'gauge' | 'candle' | 'bar' | 'rose' | 'word' | 'mix'
...
export const UchartsForBaidu = Ucharts
export const UchartsForToTiao = Ucharts
export const UchartsForWeChat = Ucharts
export const UchartsForAlipay = Ucharts
export const UchartsForH5 = Ucharts
export const UchartsForQQ = Ucharts
export const UchartsForTaro = Ucharts
export const UchartsForUniApp = Ucharts